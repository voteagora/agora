...
export const governorIndexerTest = makeIndexerDefinition(governorContractTest, {
  name: "OptimismGovernorTest",
  entities: {
...
function saveAggregate(
  ...
  handle: StorageHandleForIndexer<typeof governorIndexer>,
  entity: RuntimeType<
    typeof governorIndexerTest["entities"]["GovernorAggregates"]["serde"]
  >
) {
